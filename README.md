...
Builds the images, writes `.env`, and starts the server.
Setting `EULA=true` is required — it confirms you accept [Mojang's EULA](https://www.minecraft.net/en-us/eula).
